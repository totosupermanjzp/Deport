...
namespace Depot.Models
{
    public class DbInitializer
    {
        public static void Initialize(NameContext Context)
        {
            ...
            var names = new Name[]
            {
                new Name {Goods = "防盗门",number = 250,   EnrollmentDate = DateTime.Parse("2017-01-01"),isOut = true, location="北京" , suplierID = "001", price = 22.9},
                new Name {Goods = "键盘",  number = 199,   EnrollmentDate = DateTime.Parse("2016-12-02"),isOut = false,location="哈尔滨",suplierID = "002", price = 11.1},
                new Name {Goods = "大理石",number = 700,   EnrollmentDate = DateTime.Parse("2015-10-10"),isOut = false,location="深圳",  suplierID = "005", price = 7.8},
                new Name {Goods = "导航",  number = 200,   EnrollmentDate = DateTime.Parse("2017-02-01"),isOut = false,location="海南",  suplierID = "004", price = 9.5},
                new Name {Goods = "表",    number = 9000,  EnrollmentDate = DateTime.Parse("2017-01-25"),isOut = true, location="贵州",  suplierID = "007", price = 1.99},
                new Name {Goods = "手链",  number = 2220,  EnrollmentDate = DateTime.Parse("2016-11-11"),isOut = false,location="周口",  suplierID = "010", price = 25.0}
            };
